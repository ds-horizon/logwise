 ...
 *
 * <p>
 * Tests verify getters/setters, serialization/deserialization, and edge cases
 * for the response
 * DTO.
 */
public class SparkApplicationStageResponseTest {
    ...
    public void testDeserialization_WithJackson_WorksCorrectly() throws Exception {
        // Arrange
        String json = "{\"stageId\":1,\"status\":\"COMPLETE\",\"numCompleteTasks\":10,\"inputRecords\":1000,\"rddIds\":[1,2]}";

        // Act
        SparkApplicationStageResponse response = objectMapper.readValue(json, SparkApplicationStageResponse.class);
