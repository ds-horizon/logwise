 ...
 *
 * <p>Tests verify getters/setters, serialization/deserialization, and nested object handling.
 */
public class SparkHistoryServerGetApplicationsResponseTest {
  ...
  public void testGettersSetters_WithValidData_WorksCorrectly() {
    // Arrange
    SparkHistoryServerGetApplicationsResponse response =
        new SparkHistoryServerGetApplicationsResponse();
    List<SparkHistoryServerGetApplicationsResponse.SparkHistoryServerGetApplicationsResponseItem>
        items = new ArrayList<>();
    SparkHistoryServerGetApplicationsResponse.SparkHistoryServerGetApplicationsResponseItem item =
        new SparkHistoryServerGetApplicationsResponse
            .SparkHistoryServerGetApplicationsResponseItem();
  ...
  public void testGettersSetters_WithNestedAttempts_WorksCorrectly() {
    ...
    SparkHistoryServerGetApplicationsResponse.AttemptsItem attempt =
        new SparkHistoryServerGetApplicationsResponse.AttemptsItem();
    ...
    // Act & Assert
    Assert.assertNotNull(response.getSparkHistoryServerGetApplicationsResponse());
    List<SparkHistoryServerGetApplicationsResponse.AttemptsItem> retrievedAttempts =
        response.getSparkHistoryServerGetApplicationsResponse().get(0).getAttempts();
  ...
  public void testEquals_WithSameData_ReturnsTrue() {
    // Arrange
    SparkHistoryServerGetApplicationsResponse response1 =
        new SparkHistoryServerGetApplicationsResponse();
    List<SparkHistoryServerGetApplicationsResponse.SparkHistoryServerGetApplicationsResponseItem>
        items1 = new ArrayList<>();
    SparkHistoryServerGetApplicationsResponse.SparkHistoryServerGetApplicationsResponseItem item1 =
        new SparkHistoryServerGetApplicationsResponse
            .SparkHistoryServerGetApplicationsResponseItem();
    ...
    SparkHistoryServerGetApplicationsResponse response2 =
        new SparkHistoryServerGetApplicationsResponse();
    List<SparkHistoryServerGetApplicationsResponse.SparkHistoryServerGetApplicationsResponseItem>
        items2 = new ArrayList<>();
    SparkHistoryServerGetApplicationsResponse.SparkHistoryServerGetApplicationsResponseItem item2 =
        new SparkHistoryServerGetApplicationsResponse
            .SparkHistoryServerGetApplicationsResponseItem();
  ...
  public void testDeserialization_WithJackson_WorksCorrectly() throws Exception {
    // Arrange
    String json =
        "{\"sparkHistoryServerGetApplicationsResponse\":[{\"name\":\"app-name\",\"id\":\"app-id-123\",\"attempts\":[]}]}";

    // Act
    SparkHistoryServerGetApplicationsResponse response =
        objectMapper.readValue(json, SparkHistoryServerGetApplicationsResponse.class);
  ...
  public void testDeserialization_WithNestedAttempts_WorksCorrectly() throws Exception {
    // Arrange
    String json =
        "{\"sparkHistoryServerGetApplicationsResponse\":[{\"name\":\"app-name\",\"id\":\"app-id\",\"attempts\":[{\"duration\":1000,\"lastUpdated\":\"2021-01-01\",\"appSparkVersion\":\"3.1.2\",\"completed\":true}]}]}";
    ...
    // Assert
    Assert.assertNotNull(response);
    List<SparkHistoryServerGetApplicationsResponse.AttemptsItem> attempts =
        response.getSparkHistoryServerGetApplicationsResponse().get(0).getAttempts();
