 ...
 *
 * <p>
 * Tests verify that schemas work correctly with actual Spark DataFrame
...
public class SchemaIntegrationTest {
    ...
    public void testCreateDataFrame_WithWrongDataTypes_ThrowsException() {
        ...
        Row wrongTypeRow = RowFactory.create(
    ...
    public void testSchemaEvolution_AddingNewField_HandlesGracefully() {
        ...
        Row originalRow = RowFactory.create(
                "Test message",
                "{}",
                "2021-01-01T00:00:00Z",
                "prod",
        ...
        Dataset<Row> extended = df.withColumn("new_field",
                org.apache.spark.sql.functions.lit(null).cast(DataTypes.StringType));
