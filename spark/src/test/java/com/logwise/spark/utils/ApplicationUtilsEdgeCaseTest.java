 ...
 *
 * <p>
 * Tests verify handling of edge cases, special characters, boundary conditions,
 * and unusual
 * inputs.
 */
public class ApplicationUtilsEdgeCaseTest {
    ...
    public void testConvertProtoTimestampToSqlTimestamp_WithMaxTimestamp_HandlesCorrectly() {
        ...
        Timestamp timestamp = Timestamp.newBuilder().setSeconds(253402300799L).setNanos(999999999).build();
