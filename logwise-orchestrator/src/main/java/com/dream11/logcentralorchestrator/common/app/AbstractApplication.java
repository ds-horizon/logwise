...
import com.dream11.logcentralorchestrator.common.guice.DefaultModule;
...
public abstract class AbstractApplication {
  ...
  protected static Completable deployVerticles(
      final Vertx vertx,
      final List<com.dream11.logcentralorchestrator.common.app.Deployable> deployables) {
  ...
  protected static Single<String> deployVerticle(
      final Vertx vertx,
      final Supplier<Verticle> verticleSupplier,
      final com.dream11.logcentralorchestrator.common.app.VerticleConfig config) {
  ...
  protected Completable rxDeployVerticles() {
    ...
    com.dream11.logcentralorchestrator.common.app.AppContext.initialize(
        getAllGoogleGuiceModules(vertx));
