package com.dream11.logcentralorchestrator.error;
...
public enum ServiceError implements RestError {
  ...
  SPARK_DRIVER_KILL_ERROR(
      "LogCentralOrchestrator:SPARK_DRIVER_KILL_ERROR", "Spark Driver Kill Rest Error: %s", 500),
  BQ_QUERY_FAILED("LogCentralOrchestrator:BQ_QUERY_FAILED", "Query: %s failed with error: %s", 500),
