...
public class ApplicationConfig {
  ...
  @NonFinal @NotNull @Valid EncryptionConfig encryption;
  ...
  public static class KafkaConfig {
    @NonFinal @NotNull String kafkaManagerClusterName;
    @NonFinal @NotNull String kafkaManagerUrl;
  ...
  public static class EncryptionConfig {
    @NonFinal @NotNull String key;
    @NonFinal @NotNull String iv;
  }
}
