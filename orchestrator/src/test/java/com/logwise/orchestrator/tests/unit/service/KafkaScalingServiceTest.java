...
public class KafkaScalingServiceTest extends BaseTest {
    ...
    public void testIdentifyTopicsNeedingScaling_WithHighLag_ReturnsScalingDecision() {
        ...
        TopicPartitionMetrics metrics = TopicPartitionMetrics.builder()
                .topic(topic)
                .partitionCount(3)
        ...
        List<ScalingDecision> decisions = kafkaScalingService.identifyTopicsNeedingScaling(metricsMap, lagMap,
                kafkaConfig);
    ...
    public void testIdentifyTopicsNeedingScaling_WithMultipleTopics_ReturnsMultipleDecisions() {
        ...
        TopicPartitionMetrics metrics1 = TopicPartitionMetrics.builder()
                .topic(topic1)
                .partitionCount(3)
                .totalMessages(3_000_000L)
                .avgMessagesPerPartition(1_000_000L)
        ...
        TopicPartitionMetrics metrics2 = TopicPartitionMetrics.builder()
                .topic(topic2)
                .partitionCount(3)
                .totalMessages(3_000_000L)
                .avgMessagesPerPartition(1_000_000L)
